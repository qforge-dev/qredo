...
regexes, ranges, tuples and explicit `nil` fallback-to-default values. `tags`
overrides participate in CLI selection and expand `:__initial__` like Credo. Unknown keys and invalid values stay
