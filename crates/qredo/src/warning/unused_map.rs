...
const CHECKED_MODULE: &str = "Map";
const ISSUE_MESSAGE: &str = "There should be no unused return values for `Map` functions.";
...
mod tests {
    ...
    #[test]
    fn clean() {
        assert!(check_prepared(&crate::batch::Prepared::lazy("x = Map.get(y, :a)\n")).is_empty());
    }
    #[test]
    fn reports() {
