...
const CHECKED_MODULE: &str = "Regex";
const ISSUE_MESSAGE: &str = "There should be no unused return values for `Regex` functions.";
...
mod tests {
    ...
    #[test]
    fn clean() {
        assert!(check_prepared(&crate::batch::Prepared::lazy("x = Regex.run(a, b)\n")).is_empty());
    }
    #[test]
    fn reports() {
